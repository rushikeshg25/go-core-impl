...
func (x *Mesage) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Mesage) ProtoMessage() {}

func (x *Mesage) ProtoReflect() protoreflect.Message {
	mi := &file_message_proto_msgTypes[0]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
// Deprecated: Use Mesage.ProtoReflect.Descriptor instead.
func (*Mesage) Descriptor() ([]byte, []int) {
	return file_message_proto_rawDescGZIP(), []int{0}
}

func (x *Mesage) GetLog() string {
	if x != nil {
		return x.Log
	}
	return ""
...
var file_message_proto_goTypes = []any{
	(*Mesage)(nil), // 0: durablelogs.Mesage
}
